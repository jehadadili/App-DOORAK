...
import 'package:doorak/src/feature/upcoming_reservations/presntation/view/screen/upcoming_reservations_screen.dart';
...
class CustomContainer2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: InkWell(
        onTap: () {
          context.pushWidget(push: const UpcomingReservationsScreen());
        },
        child: Container(
          height: 155.h,
